...
$.ajax({
		url: "https://api.flickr.com/services/rest/?method=flickr.interestingness.getList&api_key=21b8dfca2fb6f130f45f45f53dae714a&per_page=100&format=json&nojsoncallback=1",
    type: "GET",
    dataType: "json",
    success: 'success'
});
